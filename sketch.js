...
var engine, world;
var canvas,playerimage;
var palyer, playerArcher;
var playerArrows = [];
var numberOfArrows = 99999;
var board1, board2;
...
function setup() {
  ...
  //player = Bodies.rectangle(250, 300, 50, 180, options);
  ...
  board1 = new Board(width - 300, 500, 50, 200);
  board2 = new Board(width - 300, 200, 50, 200);
}
